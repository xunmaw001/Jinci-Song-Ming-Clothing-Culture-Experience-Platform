<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20220805/c484e59a5aa342b9b57d5aeab159bbbd.png)","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="服饰编号" prop="fushibianhao">
					<el-input v-model="ruleForm.fushibianhao" placeholder="服饰编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.fushibianhao" label="服饰编号" prop="fushibianhao">
					<el-input v-model="ruleForm.fushibianhao" placeholder="服饰编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服饰标题" prop="fushibiaoti">
					<el-input v-model="ruleForm.fushibiaoti" placeholder="服饰标题" clearable  :readonly="ro.fushibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="服饰标题" prop="fushibiaoti">
					<el-input v-model="ruleForm.fushibiaoti" placeholder="服饰标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="样式类别" prop="yangshileibie">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="样式类别" prop="yangshileibie">
					<el-input v-model="ruleForm.yangshileibie"
						placeholder="样式类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.fushizhaopian" label="服饰照片" prop="fushizhaopian">
					<file-upload
						tip="点击上传服饰照片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.fushizhaopian" label="服饰照片" prop="fushizhaopian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服饰尺寸" prop="fushichicun">
					<el-input v-model="ruleForm.fushichicun" placeholder="服饰尺寸" clearable  :readonly="ro.fushichicun"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="服饰尺寸" prop="fushichicun">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="服饰详情" prop="fushixiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.fushixiangqing" label="服饰详情" prop="fushixiangqing">
