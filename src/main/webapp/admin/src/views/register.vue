<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","backgroundAttachment":"fixed","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220805/558e19d5638d40eba231e492c1a85023.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"0 40px 100px","boxShadow":"0px 4px 10px 0px rgba(223,223,223,0.3)","margin":"0","borderRadius":"0","background":"#fff","width":"680px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0 auto 40px","color":"#000","textAlign":"center","background":"#D5EBC4","width":"100%","lineHeight":"80px","fontSize":"25px","fontWeight":"bold"}' class="title">晋祠宋明服饰文化体验平台注册</div>
				<el-form-item :style='{"width":"100%","padding":"0","margin":"14px auto","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
